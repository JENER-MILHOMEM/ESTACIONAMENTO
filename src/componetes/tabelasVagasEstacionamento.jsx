...
function tabelasVagasEstacionamento() {
  return (
    <div className=" px-10 flex pb-28">
      ...
      <div className="px-5 bg-white  py-10 flex flex-col space-x-14  gap-3">
        <div className="px-40 font-bold text-purple-600">
          <h1>Veiculo Grande</h1>
        </div>
        <div className="px-36 text-purple-600">
      ...
      <div className="px-5 bg-white rounded-r-lg  flex flex-col space-x-14 pt-16 gap-3">
...
export default tabelasVagasEstacionamento;
